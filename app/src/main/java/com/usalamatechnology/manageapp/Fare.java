...
public class Fare extends AppCompatActivity implements HomeIObserver {
...
//        rv.setHasFixedSize(true);
        ...
        if (CheckNetwork.isInternetAvailable(Fare.this)) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, getAllVehicles,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        dialogBuilder = NiftyDialogBuilder.getInstance(Fare.this);
                        dialogBuilder
                    ...
                    public void onResponse(String s) {
                        if (s != null) {
                            ...
                            try {
                                ...
                                e.printStackTrace();
                                Toast.makeText(Fare.this, "Error Fetching Data", Toast.LENGTH_LONG).show();
                                results = false;
                            }
                        }
                        System.out.println("MAIN response " + s);
